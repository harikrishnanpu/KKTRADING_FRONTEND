...
export default function SearchBox() {
  ...
  return (
    <div className="relative w-full flex">
      {/* Search Input */} 
        <input onKeyDown={(e)=> handleKeyPress(e)} onChange={(e)=> setName(e.target.value)} value={name} type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-300" placeholder="Search Products" required />
    <button onClick={submitHandler} className="px-2.5 mx-2 ms-2 text-sm font-medium text-white bg-red-600 rounded-lg border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
